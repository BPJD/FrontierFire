...
namespace Kamgam.TriplanarShader
{
    ...
    public abstract class TriplanarMaterial : MonoBehaviour
    {
        ...
        public bool GetLocalSpace()
        {
            return getProperty(PropertySetter.GetFloat, PropertyBlockSetter.GetFloat, TriplanarMaterialProperties.LocalSpace, TriplanarMaterialProperties.LocalSpaceDefault) > 0.5f;
        }

        public void SetLocalSpace(bool value)
        {
            setProperty(PropertySetter.SetFloat, PropertyBlockSetter.ScheduleFloat, TriplanarMaterialProperties.LocalSpace, value ? 1f : 0f);
        }
